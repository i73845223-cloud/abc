...
import UpcomingMatchesClient from '../upcoming-matches/upcoming-matches-client'
import { Book as BookType } from '@/app/types/bookmaking'
import UpcomingMatchesEmpty from '../upcoming-matches/upcoming-matches-empty'
import FootballMatchesHeader from './football-matches-header'

async function getFootballMatches(): Promise<BookType[]> {
  try {
...
export default async function FootballMatches() {
  const upcomingMatches = await getFootballMatches()
