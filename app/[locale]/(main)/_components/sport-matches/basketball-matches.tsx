...
import BasketballMatchesHeader from './backetball-matches-header'

async function getBasketballMatches(): Promise<BookType[]> {
  try {
...
export default async function BasketballMatches() {
