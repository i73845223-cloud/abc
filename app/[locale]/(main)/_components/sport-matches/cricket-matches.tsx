...
import CricketMatchesHeader from './cricket-matches-header'

async function getCricketlMatches(): Promise<BookType[]> {
  try {
...
export default async function CricketMatches() {
  const upcomingMatches = await getCricketlMatches()
