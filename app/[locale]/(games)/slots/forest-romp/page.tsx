...
import slotBg from "@/public/forest-romp/bg.webp";
import frameOverlay from "@/public/forest-romp/frame.webp";
...
const SlotMachine = () => {
  ...
  const animateReels = () => {
    ...
    const symbolHeight = isXS ? 43 : isMobile ? 72 : 135;
  ...
  const renderSymbol = (symbol: typeof SYMBOLS[0]['symbol'], colIndex: number, rowIndex: number) => {
    ...
    return (
      <div 
        className={`flex justify-center items-center w-full sm:h-[72px] xl:h-[135px] h-[43px] transition-all duration-300 ${
  ...
  const renderReel = (col: typeof SYMBOLS[0]['symbol'][], colIndex: number) => (
    <div 
      key={colIndex} 
      className="flex flex-col items-center h-full w-[65px] sm:w-[105px] xl:w-[200px] overflow-hidden relative mx-[1px] z-10"
    >
      <div 
  ...
  return (
    <div className="bg-black overflow-hidden min-h-screen min-w-screen relative">
      ...
      <div className="flex flex-col items-center xl:justify-center gap-8 text-center min-h-[calc(100vh-100px)] relative z-2">
        <div className="absolute xl:mt-[0px] sm:mt-[200px] mt-[160px] [@media(max-height:700px)]:mt-[110px] xl:left-[50px] md:left-[0px] z-3">
          <div className="relative flex justify-center items-center w-[95vw] h-[147px] sm:h-[234px] xl:w-[1100px] max-w-[360px] sm:max-w-[600px] xl:max-w-[1100px] xl:h-[422px] overflow-hidden p-2 rounded-xl">
            {reels.map((col, colIndex) => renderReel(col, colIndex))}
          </div>
          
          <div className="absolute inset-0 w-full h-full z-1 xl:top-[50px] sm:top-[33px] top-[23px] -translate-y-1/2 sm:max-w-[600px] xl:max-w-[1100px]">
            <Image
              width={1100}
              src={frameOverlay} 
              alt="Frame Overlay" 
