...
import slotBg from "@/public/villagers-dream/bg.webp";
import frameOverlay from "@/public/villagers-dream/frame.webp";
  ...
  return (
    <div className="bg-black overflow-hidden min-h-screen min-w-screen relative">
      ...
      <div className="flex flex-col items-center xl:justify-center gap-8 text-center min-h-[calc(100vh-100px)] relative z-2">
        <div className="absolute xl:mt-[10px] sm:mt-[120px] mt-[160px] [@media(max-height:700px)]:mt-[110px] xl:left-[150px] md:left-[50px] z-3">
